...
def super_user_event_create(request):
    if request.method == "POST":
        ...
        form = EventForm()
    return render(
        request, "users/super_user_event_form.html", {"form": form, "mode": "create"}
    )
...
def super_user_event_edit(request, pk):
    ...
    return render(
        request,
        "users/super_user_event_form.html",
...
def super_user_event_delete(request, pk):
    ...
    if request.method == "POST":
        ...
        return redirect("users:super_user_events_list")
    return render(
        request, "users/super_user_event_delete_confirm.html", {"event": event}
    )
