...
from apps.users.views import UserHomeView
...
class TestUserHomeView:
    def test_user_home_page_returns_200(self):
        ...
        request = factory.get("/users/home/")
    ...
    def test_user_home_page_redirects_to_login(self):
        ...
        assert response.url == "/users/login/?next=/users/home/"
        assert response.status_code == 302
    ...
    def test_user_home_page_uses_correct_template(self):
        ...
        with patch("apps.users.views.render") as mock_render:
            ...
            assert template_name == "users/user_home.html"
...
class TestCustomLoginView:
    def test_custom_login_page_returns_200(self):
        ...
        # Assert response code
        assert response.status_code == 302
        assert response.url == "/users/login/?next=/users/login/"
