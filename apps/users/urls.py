...
from . views_superuser import \
    super_user_dashboard, delete_user
from . views_superuser_events import \
    super_user_events_list, super_user_event_create, super_user_event_edit, super_user_event_delete
...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>/', 
        ...
        path("super_user/events/add/", super_user_event_create, name="super_user_event_create"),
        path("super_user/events/edit/<int:pk>/", super_user_event_edit, name="super_user_event_edit"),
        path("super_user/events/delete/<int:pk>/", super_user_event_delete, name="super_user_event_delete"),
]
